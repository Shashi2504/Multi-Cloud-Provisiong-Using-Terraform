...
data "azurerm_kubernetes_cluster" "cluster" {
    name = data.azurerm_kubernetes_cluster.aks.outputs.kubernetes_cluster_name
    resource_group_name = data.azurerm_kubernetes_cluster.aks.outputs.resource_group_name
}
...
provider "kubernetes" {
    ...
    exec {
      ...
      args = ["eks", "get-token", "--cluster-name", data.azurerm_kubernetes_cluster.cluster.name]
      command = "aws"
    }
}
